        ...
        @else
            <div class="row my-4 py-4 rounded-bottom border-top bg-light text-capitalize">
                <div class="col-sm-12 col-md-7 col-lg-7" style="font-size: 2rem;">
                    <span class="d-block w-100 my-3">@lang('text.momo_number') : <span class="text-primary">{{ $appl->momo_number }}</span></span>
                    <span class="d-block w-100 my-3">@lang('text.momo_transaction_id') : <span class="text-primary">{{ $appl->momo_transaction_id }}</span></span>
                    <span class="d-block w-100 my-3">@lang('text.amount_paid') : <span class="text-primary">{{ $appl->amount }} @lang('text.currency_cfa')</span></span>
                </div>
