...
class ApiService{
    ...
    public function class_portal_fee_structure($program, $level, $year_id = null, $option=null, $campus_id = null){
        return Http::get(Helpers::instance()->getApiRoot()."/class_portal_fee_structure/{$program}/{$level}/{$year_id}?option={$option}&campus_id={$campus_id}")->collect();
    }
